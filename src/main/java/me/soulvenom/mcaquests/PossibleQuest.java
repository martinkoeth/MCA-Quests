...
public class PossibleQuest {
    ...
    public PossibleQuest(List<Personality> personalities, boolean personalitiesIsBlacklist, List<String> moods,
                         boolean moodsIsBlacklist, List<Traits.Trait> traits, boolean traitIsBlacklist,
                         QuestType questType, String target, int min, int max, int minRelation, int maxRelation, int possibility) {
